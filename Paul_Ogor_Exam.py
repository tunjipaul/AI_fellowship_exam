...
while True:
    ...
    try:
        ...
        choice = input(
            "Select an operation; (+, -, *, /) or type Exit to quit: ").strip().lower()

        if choice == "+":
            print(f"The sum of {num_1} + {num_2} = {add_task(num_1, num_2)} ")
        elif choice == "-":
            print(
                f"The subtraction of {num_1} - {num_2} = {subtract_task(num_1, num_2)} ")
        elif choice == "*":
            print(
                f"The multiplication of {num_1} * {num_2} = {multiply_task(num_1, num_2)} ")
        elif choice == "/":
            print(
                f"The division of {num_1} / {num_2} = {divide(num_1, num_2)} ")
        elif choice == "exit":
